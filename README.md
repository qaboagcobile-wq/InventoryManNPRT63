...
| **TC-03** | **Admin Login & Store Name Reveal** | Admin | 1. Sign in with `aqabo@gmail.com`<br>2. Change password if prompted | Logs in to Admin console. Header displays *"Platform Management"*. Top quick-test banner is gone. |
